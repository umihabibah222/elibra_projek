            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    foreach ($penerbit as $key => $value){ ?>
                        ...
                        <td>
                        <button type="button" class="btn  btn-warning btn-primary btn-flat btn-sm" data-toggle="modal" data-target="#modal-edit<?= $value['id_penerbit'] ?>">
                            <i class="fas fa-edit"></i> 
                        </button>
                        <button type="button" class="btn btn-danger btn-primary btn-flat btn-sm" data-toggle="modal" data-target="#modal-delete<?= $value['id_penerbit'] ?>">
    ...
    <div class="modal fade" id="modal-delete<?= $value['id_penerbit'] ?>">
            ...
            <div class="modal-content">
                ...
                <?php echo form_open(base_url('Penerbit/DeleteData/' . $value['id_penerbit'])) ?>
                    <div class="form-group">
                        <p style="color: black;">Apakah Yakin Akan Hapus Data <b style="color: red;" ><?= $value['nama_penerbit'] ?></b>...?</p>
                    </div>
                </div>
